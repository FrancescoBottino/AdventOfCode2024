...
object Day05 {
    ...
    fun main(args: Array<String>) {
        ...
        println("Part 1 test")
        printTimedResult(expectedValue = 143) {
            part1(testInput)
        }

        println("Part 1")
        printTimedResult(expectedValue = 5964) {
            part1(input)
        }

        println("Part 2 test")
        printTimedResult(expectedValue = 123) {
            part2(testInput)
        }

        println("Part 2")
        printTimedResult(expectedValue = 4719) {
            part2(input)
        }
    }
    ...
    private fun List<Int>.getValueIfIncorrect(trailingMap: Map<Int, Set<Int>>, leadingMap: Map<Int, Set<Int>>): Int? {
        ...
        return if(updatedPages == this)
            null
        else
            updatedPages[updatedPages.indices.last / 2]
    }
