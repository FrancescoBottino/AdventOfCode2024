...
object Day07 {
    ...
    fun main(args: Array<String>) {
        ...
        println("Part 1 test")
        printTimedResult(expectedValue = 3749) {
            part1(testInput)
        }

        println("Part 1")
        printTimedResult(expectedValue = 4555081946288) {
            part1(input)
        }

        println("Part 2 test")
        printTimedResult(expectedValue = 11387) {
            part2(testInput)
        }

        println("Part 2")
        printTimedResult(expectedValue = 227921760109726) {
            part2(input)
        }
    }
